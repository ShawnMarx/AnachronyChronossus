...
export const CHRONOBOT_OVERLAYS: BotOverlay[] = [
  ...
  { key: 'uranium', pos: [58.3, 20.6], width: 7.7, curve: 24.4 },
  { key: 'gold', pos: [58.3, 33], width: 7.7, curve: 24.2 },
  { key: 'titanium', pos: [58.3, 45.8], width: 7.7, curve: 23.8 },
  ...
  { key: 'factory', pos: [55.3, 89], width: 12.2 },
  { key: 'support', pos: [67.4, 89], width: 12.2 },
  { key: 'lab', pos: [79.9, 89], width: 12.2 },
  { key: 'anomaly', pos: [93.8, 89], width: 12.2 },
  { key: 'superproject', pos: [22.8, 89], width: 25 },
  { key: 'breakthrough', pos: [5.3, 89], width: 5.8 },
];
