...
export const CHRONOSSUS_OVERLAYS: BotOverlay[] = [
  ...
  { key: 'neutronium', pos: [62.9, 8.2], width: 7.6, curve: 24.2 },
  { key: 'uranium', pos: [62.9, 20.6], width: 7.7, curve: 24.4 },
  { key: 'gold', pos: [62.9, 33.4], width: 7.7, curve: 24.2 },
  { key: 'titanium', pos: [62.9, 45.9], width: 7.7, curve: 23.8 },
  { key: 'genius', pos: [73.7, 7.9], width: 5.8 },
  { key: 'administrator', pos: [73.7, 20.4], width: 5.8 },
  { key: 'engineer', pos: [73.7, 33.1], width: 5.8 },
  { key: 'scientist', pos: [73.7, 45.7], width: 5.8 },
  { key: 'powerplant', pos: [42.7, 89], width: 12.2 },
  { key: 'factory', pos: [55.2, 89], width: 12.2 },
  { key: 'support', pos: [67.6, 89], width: 12.2 },
  { key: 'lab', pos: [79.8, 89], width: 12.2 },
  { key: 'anomaly', pos: [93.7, 89], width: 12.2 },
  { key: 'superproject', pos: [22.9, 89], width: 25 },
  { key: 'breakthrough', pos: [5.2, 89], width: 5.8 },
];
